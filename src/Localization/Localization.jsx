const Localization = {
  en: {
    ...
    about:{
      ...
      text1: 'Creative, experienced, ambitious and self-confident team. The key to our confidence is not only in the level of professionalism, qualifications and responsibility of our specialists, but also in a large and successful experience in the implementation of various construction projects.',
      text2: 'Thirteen years of work on the market is a good, objective indicator of stability and success based on consumer confidence.',
  ...
  ru: {
    ...
    about:{
      company: 'О компании',
      text1: 'Творческая, опытная, амбициозная и уверенная в себе команда. Залог нашей уверенности - не только в уровне профессионализма, квалификации и ответственности наших специалистов, но и в большом и успешном опыте реализации различных строительных проектов.',
      text2: 'Тринадцать лет работы на рынке — это хороший, объективный показатель стабильности и успеха, основанного на доверии потребителей.',
