    ...
    <main>
      <section className={styles.about}>
        <div className={`container ${styles.container}`}>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LLC
                ONUR, 293 Usta Shirin street, Almazar district, Tashkent City, Republic of
                Uzbekistan, 100057..
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Onur Company, accessible from
                <a href="https://onurcompany.com/" rel="noreferrer" target="_blank">
                  https://onurcompany.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: info@onurcompany.com</p>
            </li>
            <li>
              <p>
                By visiting this page on our website:
                <a href="https://onurcompany.com/contacts" rel="noreferrer" target="_blank">
                  https://onurcompany.com/contacts
                </a>
              </p>
            </li>
            <li>
              <p>By phone number: +998555001222</p>
            </li>
          </ul>
        </div>
      </section>
